...
function energy(::Type{<:BinaryQMCState{Power}}, H::AbstractIsing, ns::Vector{<:Real}; resampler::Function=jackknife)
    hx = total_hx(H)
...
function energy(::Type{<:BinaryQMCState{Power}}, H::AbstractIsing, ns_mean::Real)
    hx = total_hx(H)
